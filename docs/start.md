...
> 运行CAT▪IOT-IDE物联网集成开发环境
  ...
  - 将软件包catiotide-win-x64-*拷贝到小电脑
  - 双击catiotide-win-x64-*.exe启动服务，服务窗口如下：
...
- 从组件箱中拖出需要的显示组件，调整属性，最终页面显示效果如下：
...
> 协议解析
  ...
  协议解析需要获取空气盒子数据，建立解析脚本模块，在脚本模块中编程解析出设备测量值。

  - 从资源箱中，进入“通信” - “MQTT”，拖出mqttClient资源模块，创建“mqttClient_1”虚拟设备实例，按照下图中所示，配置输入数据点参数，这样，mqttClient_1也能够连接到mqttServer_1:
  
  ![start](../image/s20.png)

  - 在“本地”中，选择创建“脚本模块”，命名为“协议解析”，拖放到工作区后生成“协议解析_1”实例，双击打开脚本编辑器，为“协议解析”脚本模块创建如下的数据点：
  ...
  双击“协议解析_1”脚本模块，打开脚本编辑器，在其中用js编写解析程序：
